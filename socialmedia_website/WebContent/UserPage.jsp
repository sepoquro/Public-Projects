...
<%
	...
	User user = (User) session.getAttribute("userClickedObject");
	String name = user.getFname()+" "+user.getLname();
	String username = "@"+user.getUsername();
	User loggeduser = (User) session.getAttribute("user");
	String loggedimage = loggeduser.getImage();
			...
			<div class="searchheader">
				<form name="feedprofilebuttonform" method="GET" action="ChoiceServlet">
					...
					<div class="profilebuttoncontainer">
						<input type="image" src="<%=loggedimage%>" class="smallcircleImage" name="choice" value="4. View Profile" />
					</div>
