...
<%
	...
	if(movieSearchType.equals("actor")){
		prompt = "Enter an actor to search for.";
	} else if(movieSearchType.equals("title")){
		prompt = "Enter a movie to search for.";
	} else if(movieSearchType.equals("genre")){
		prompt = "Enter a genre to search for.";
	}
		...
		<div id="main">
			<div id="input">
				<div class="searchBody">
		           	...
		           	<div class="results">
			           	<form name="searchmoviebuttonform" method="GET" action="MoviePageServlet">
				           	<%for(int i=0;i<searchResults.size();i++){%>
								<p><input type="submit" name="movieClicked" value="<%=searchResults.get(i)%>" class="noborderbutton" /></p>
							<%}%>
						</form>
					</div>
		           	<%=errorMessage%>
